...
const LoginForm: React.FC = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    formData.append("btn-login", "submit");
    formData.append("txt_uname_email", data.email);
    formData.append("txt_password", data.password);

    try {
      const response = await fetch(
        "https://politicaegestao.com/login/index.php",
        {
          method: "POST",
          body: formData,
        }
