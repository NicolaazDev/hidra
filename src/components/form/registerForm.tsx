...
const RegisterForm: React.FC = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    formData.append("subscribe", "submit");
    formData.append("txt_uname", data.username);
    formData.append("txt_email", data.email);
    formData.append("txt_upass", data.password);

    try {
      const response = await fetch(
        "https://politicaegestao.com/login/sign-up.php",
        {
          method: "POST",
          body: formData,
        }
